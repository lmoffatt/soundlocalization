...
```{r}
sp_rec <- obtain_source_positions_from_lags(g_rec,max_number_of_sources_per_frame = 10,fraction_of_sum_of_values = 0.8,keep_if_z_is_greater_than = 5,keep_the_best_n = 200,min_freq = NULL,max_freq = 8000,signal_filter = F,freq_filter = T)
