...
```{r}
for (i in 1:length(a_recordings$signal))
{
...
```{r}
  gcc_phase_plot(rec = a_recordings,t_start =  118,t_end = 120.8,min_freq = 500,max_freq = 6000,lag_window_in_meters = 20,remove_if_z_is_greater_than=5)
```
...
for (i in 1:length(a_recordings$signal))
{
  spectro_plot(recordings = a_recordings,i,start = 120.8,end=122,listen=T,min_freq = 00,max_f=500,listen_freq = 1)
...
```{r}
  spectro_plot(recordings = a_recordings,4,start = 0,end=10,listen=T,min_freq = 2500,max_f=4500,listen_freq = 1)
...
for (i in 1:length(a_recordings$signal))
{
  spectro_plot(recordings = a_recordings,i,start = 122,end=127,listen=T, min_freq = 500,max_freq = 4000)
 # listen(recordings = a_recordings,i,start = 120.8,end=125)
}
